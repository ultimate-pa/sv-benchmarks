...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix008.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t213;
  pthread_create(&t213, ((void *)0), P0, ((void *)0));
  pthread_t t214;
  pthread_create(&t214, ((void *)0), P1, ((void *)0));
  pthread_t t215;
  pthread_create(&t215, ((void *)0), P2, ((void *)0));
  pthread_t t216;
  pthread_create(&t216, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
