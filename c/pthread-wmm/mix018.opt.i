...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix018.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t469;
  pthread_create(&t469, ((void *)0), P0, ((void *)0));
  pthread_t t470;
  pthread_create(&t470, ((void *)0), P1, ((void *)0));
  pthread_t t471;
  pthread_create(&t471, ((void *)0), P2, ((void *)0));
  pthread_t t472;
  pthread_create(&t472, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
