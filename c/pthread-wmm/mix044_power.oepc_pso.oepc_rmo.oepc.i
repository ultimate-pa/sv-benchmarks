...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix044_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1161;
  pthread_create(&t1161, ((void *)0), P0, ((void *)0));
  pthread_t t1162;
  pthread_create(&t1162, ((void *)0), P1, ((void *)0));
  pthread_t t1163;
  pthread_create(&t1163, ((void *)0), P2, ((void *)0));
  pthread_t t1164;
  pthread_create(&t1164, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
