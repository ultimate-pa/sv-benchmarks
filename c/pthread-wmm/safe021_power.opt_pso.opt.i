...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe021_power.opt_pso.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2284;
  pthread_create(&t2284, ((void *)0), P0, ((void *)0));
  pthread_t t2285;
  pthread_create(&t2285, ((void *)0), P1, ((void *)0));
  pthread_t t2286;
  pthread_create(&t2286, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
