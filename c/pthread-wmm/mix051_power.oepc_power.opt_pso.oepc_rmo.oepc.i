...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix051_power.oepc_power.opt_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1353;
  pthread_create(&t1353, ((void *)0), P0, ((void *)0));
  pthread_t t1354;
  pthread_create(&t1354, ((void *)0), P1, ((void *)0));
  pthread_t t1355;
  pthread_create(&t1355, ((void *)0), P2, ((void *)0));
  pthread_t t1356;
  pthread_create(&t1356, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
