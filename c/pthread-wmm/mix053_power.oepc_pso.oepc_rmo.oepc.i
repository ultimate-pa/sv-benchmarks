...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix053_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1409;
  pthread_create(&t1409, ((void *)0), P0, ((void *)0));
  pthread_t t1410;
  pthread_create(&t1410, ((void *)0), P1, ((void *)0));
  pthread_t t1411;
  pthread_create(&t1411, ((void *)0), P2, ((void *)0));
  pthread_t t1412;
  pthread_create(&t1412, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
