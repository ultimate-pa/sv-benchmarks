...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix001.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t17;
  pthread_create(&t17, ((void *)0), P0, ((void *)0));
  pthread_t t18;
  pthread_create(&t18, ((void *)0), P1, ((void *)0));
  pthread_t t19;
  pthread_create(&t19, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
