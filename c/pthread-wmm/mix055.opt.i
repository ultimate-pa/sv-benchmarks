...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix055.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1461;
  pthread_create(&t1461, ((void *)0), P0, ((void *)0));
  pthread_t t1462;
  pthread_create(&t1462, ((void *)0), P1, ((void *)0));
  pthread_t t1463;
  pthread_create(&t1463, ((void *)0), P2, ((void *)0));
  pthread_t t1464;
  pthread_create(&t1464, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
