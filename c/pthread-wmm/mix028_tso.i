...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix028_tso.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t763;
  pthread_create(&t763, ((void *)0), P0, ((void *)0));
  pthread_t t764;
  pthread_create(&t764, ((void *)0), P1, ((void *)0));
  pthread_t t765;
  pthread_create(&t765, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
