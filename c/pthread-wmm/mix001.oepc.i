...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix001.oepc.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t14;
  pthread_create(&t14, ((void *)0), P0, ((void *)0));
  pthread_t t15;
  pthread_create(&t15, ((void *)0), P1, ((void *)0));
  pthread_t t16;
  pthread_create(&t16, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
