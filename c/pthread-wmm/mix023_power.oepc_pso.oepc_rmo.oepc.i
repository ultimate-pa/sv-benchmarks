...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix023_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t601;
  pthread_create(&t601, ((void *)0), P0, ((void *)0));
  pthread_t t602;
  pthread_create(&t602, ((void *)0), P1, ((void *)0));
  pthread_t t603;
  pthread_create(&t603, ((void *)0), P2, ((void *)0));
  pthread_t t604;
  pthread_create(&t604, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
