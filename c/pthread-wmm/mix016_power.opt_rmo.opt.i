...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix016_power.opt_rmo.opt.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t412;
  pthread_create(&t412, ((void *)0), P0, ((void *)0));
  pthread_t t413;
  pthread_create(&t413, ((void *)0), P1, ((void *)0));
  pthread_t t414;
  pthread_create(&t414, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
