...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix011_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t281;
  pthread_create(&t281, ((void *)0), P0, ((void *)0));
  pthread_t t282;
  pthread_create(&t282, ((void *)0), P1, ((void *)0));
  pthread_t t283;
  pthread_create(&t283, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
