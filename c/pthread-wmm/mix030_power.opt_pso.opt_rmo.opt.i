...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix030_power.opt_pso.opt_rmo.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t805;
  pthread_create(&t805, ((void *)0), P0, ((void *)0));
  pthread_t t806;
  pthread_create(&t806, ((void *)0), P1, ((void *)0));
  pthread_t t807;
  pthread_create(&t807, ((void *)0), P2, ((void *)0));
  pthread_t t808;
  pthread_create(&t808, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
