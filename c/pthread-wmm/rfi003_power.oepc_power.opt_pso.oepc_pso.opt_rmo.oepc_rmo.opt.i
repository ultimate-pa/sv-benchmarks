...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "rfi003_power.oepc_power.opt_pso.oepc_pso.opt_rmo.oepc_rmo.opt.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1633;
  pthread_create(&t1633, ((void *)0), P0, ((void *)0));
  pthread_t t1634;
  pthread_create(&t1634, ((void *)0), P1, ((void *)0));
  __VERIFIER_atomic_begin();
