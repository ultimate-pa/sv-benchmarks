...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix014.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t357;
  pthread_create(&t357, ((void *)0), P0, ((void *)0));
  pthread_t t358;
  pthread_create(&t358, ((void *)0), P1, ((void *)0));
  pthread_t t359;
  pthread_create(&t359, ((void *)0), P2, ((void *)0));
  pthread_t t360;
  pthread_create(&t360, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
