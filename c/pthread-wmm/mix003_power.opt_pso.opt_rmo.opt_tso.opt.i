...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix003_power.opt_pso.opt_rmo.opt_tso.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t65;
  pthread_create(&t65, ((void *)0), P0, ((void *)0));
  pthread_t t66;
  pthread_create(&t66, ((void *)0), P1, ((void *)0));
  pthread_t t67;
  pthread_create(&t67, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
