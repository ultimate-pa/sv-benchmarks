...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe011_power.opt_pso.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2028;
  pthread_create(&t2028, ((void *)0), P0, ((void *)0));
  pthread_t t2029;
  pthread_create(&t2029, ((void *)0), P1, ((void *)0));
  pthread_t t2030;
  pthread_create(&t2030, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
