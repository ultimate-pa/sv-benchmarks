...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "rfi008.opt.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1723;
  pthread_create(&t1723, ((void *)0), P0, ((void *)0));
  pthread_t t1724;
  pthread_create(&t1724, ((void *)0), P1, ((void *)0));
  __VERIFIER_atomic_begin();
