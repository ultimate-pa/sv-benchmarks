...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix035.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t913;
  pthread_create(&t913, ((void *)0), P0, ((void *)0));
  pthread_t t914;
  pthread_create(&t914, ((void *)0), P1, ((void *)0));
  pthread_t t915;
  pthread_create(&t915, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
