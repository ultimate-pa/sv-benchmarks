...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix002.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t38;
  pthread_create(&t38, ((void *)0), P0, ((void *)0));
  pthread_t t39;
  pthread_create(&t39, ((void *)0), P1, ((void *)0));
  pthread_t t40;
  pthread_create(&t40, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
