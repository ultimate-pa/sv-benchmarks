...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix024_power.oepc_pso.oepc_rmo.oepc_tso.oepc_tso.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t633;
  pthread_create(&t633, ((void *)0), P0, ((void *)0));
  pthread_t t634;
  pthread_create(&t634, ((void *)0), P1, ((void *)0));
  pthread_t t635;
  pthread_create(&t635, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
