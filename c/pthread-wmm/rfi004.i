...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "rfi004.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1649;
  pthread_create(&t1649, ((void *)0), P0, ((void *)0));
  pthread_t t1650;
  pthread_create(&t1650, ((void *)0), P1, ((void *)0));
  __VERIFIER_atomic_begin();
