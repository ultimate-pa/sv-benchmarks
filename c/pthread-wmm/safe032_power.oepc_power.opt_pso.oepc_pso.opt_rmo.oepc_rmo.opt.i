...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe032_power.oepc_power.opt_pso.oepc_pso.opt_rmo.oepc_rmo.opt.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2537;
  pthread_create(&t2537, ((void *)0), P0, ((void *)0));
  pthread_t t2538;
  pthread_create(&t2538, ((void *)0), P1, ((void *)0));
  pthread_t t2539;
  pthread_create(&t2539, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
