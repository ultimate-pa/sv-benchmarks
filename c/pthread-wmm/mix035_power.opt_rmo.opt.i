...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix035_power.opt_rmo.opt.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t916;
  pthread_create(&t916, ((void *)0), P0, ((void *)0));
  pthread_t t917;
  pthread_create(&t917, ((void *)0), P1, ((void *)0));
  pthread_t t918;
  pthread_create(&t918, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
