...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix038.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1004;
  pthread_create(&t1004, ((void *)0), P0, ((void *)0));
  pthread_t t1005;
  pthread_create(&t1005, ((void *)0), P1, ((void *)0));
  pthread_t t1006;
  pthread_create(&t1006, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
