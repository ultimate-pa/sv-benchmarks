...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe033_power.oepc_power.opt_pso.oepc_pso.opt_rmo.oepc_rmo.opt.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2561;
  pthread_create(&t2561, ((void *)0), P0, ((void *)0));
  pthread_t t2562;
  pthread_create(&t2562, ((void *)0), P1, ((void *)0));
  __VERIFIER_atomic_begin();
