...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix056_power.opt_pso.opt_rmo.opt_tso.oepc_tso.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1492;
  pthread_create(&t1492, ((void *)0), P0, ((void *)0));
  pthread_t t1493;
  pthread_create(&t1493, ((void *)0), P1, ((void *)0));
  pthread_t t1494;
  pthread_create(&t1494, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
