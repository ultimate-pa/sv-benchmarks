...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix050.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1321;
  pthread_create(&t1321, ((void *)0), P0, ((void *)0));
  pthread_t t1322;
  pthread_create(&t1322, ((void *)0), P1, ((void *)0));
  pthread_t t1323;
  pthread_create(&t1323, ((void *)0), P2, ((void *)0));
  pthread_t t1324;
  pthread_create(&t1324, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
