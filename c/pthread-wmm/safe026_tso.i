...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe026_tso.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2411;
  pthread_create(&t2411, ((void *)0), P0, ((void *)0));
  pthread_t t2412;
  pthread_create(&t2412, ((void *)0), P1, ((void *)0));
  pthread_t t2413;
  pthread_create(&t2413, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
