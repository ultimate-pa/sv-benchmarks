...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe019_pso.oepc_pso.opt_tso.oepc_tso.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2233;
  pthread_create(&t2233, ((void *)0), P0, ((void *)0));
  pthread_t t2234;
  pthread_create(&t2234, ((void *)0), P1, ((void *)0));
  pthread_t t2235;
  pthread_create(&t2235, ((void *)0), P2, ((void *)0));
  pthread_t t2236;
  pthread_create(&t2236, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
