...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix042.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1108;
  pthread_create(&t1108, ((void *)0), P0, ((void *)0));
  pthread_t t1109;
  pthread_create(&t1109, ((void *)0), P1, ((void *)0));
  pthread_t t1110;
  pthread_create(&t1110, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
