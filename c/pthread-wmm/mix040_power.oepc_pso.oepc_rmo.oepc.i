...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix040_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1057;
  pthread_create(&t1057, ((void *)0), P0, ((void *)0));
  pthread_t t1058;
  pthread_create(&t1058, ((void *)0), P1, ((void *)0));
  pthread_t t1059;
  pthread_create(&t1059, ((void *)0), P2, ((void *)0));
  pthread_t t1060;
  pthread_create(&t1060, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
