...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe028_pso.oepc_pso.opt_tso.oepc_tso.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2455;
  pthread_create(&t2455, ((void *)0), P0, ((void *)0));
  pthread_t t2456;
  pthread_create(&t2456, ((void *)0), P1, ((void *)0));
  pthread_t t2457;
  pthread_create(&t2457, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
