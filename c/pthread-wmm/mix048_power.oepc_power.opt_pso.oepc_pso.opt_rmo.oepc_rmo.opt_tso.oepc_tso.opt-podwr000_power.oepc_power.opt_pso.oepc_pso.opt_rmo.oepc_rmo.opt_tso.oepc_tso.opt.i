...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix048_power.oepc_power.opt_pso.oepc_pso.opt_rmo.oepc_rmo.opt_tso.oepc_tso.opt-podwr000_power.oepc_power.opt_pso.oepc_pso.opt_rmo.oepc_rmo.opt_tso.oepc_tso.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1281;
  pthread_create(&t1281, ((void *)0), P0, ((void *)0));
  pthread_t t1282;
  pthread_create(&t1282, ((void *)0), P1, ((void *)0));
  __VERIFIER_atomic_begin();
