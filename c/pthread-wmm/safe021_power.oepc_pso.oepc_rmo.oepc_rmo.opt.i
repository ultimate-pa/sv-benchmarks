...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe021_power.oepc_pso.oepc_rmo.oepc_rmo.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2281;
  pthread_create(&t2281, ((void *)0), P0, ((void *)0));
  pthread_t t2282;
  pthread_create(&t2282, ((void *)0), P1, ((void *)0));
  pthread_t t2283;
  pthread_create(&t2283, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
