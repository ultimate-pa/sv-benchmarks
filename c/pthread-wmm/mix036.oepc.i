...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix036.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t937;
  pthread_create(&t937, ((void *)0), P0, ((void *)0));
  pthread_t t938;
  pthread_create(&t938, ((void *)0), P1, ((void *)0));
  pthread_t t939;
  pthread_create(&t939, ((void *)0), P2, ((void *)0));
  pthread_t t940;
  pthread_create(&t940, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
