...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix054_power.oepc_power.opt_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1441;
  pthread_create(&t1441, ((void *)0), P0, ((void *)0));
  pthread_t t1442;
  pthread_create(&t1442, ((void *)0), P1, ((void *)0));
  __VERIFIER_atomic_begin();
