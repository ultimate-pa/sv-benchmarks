...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe029_power.opt_pso.opt_rmo.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2475;
  pthread_create(&t2475, ((void *)0), P0, ((void *)0));
  pthread_t t2476;
  pthread_create(&t2476, ((void *)0), P1, ((void *)0));
  __VERIFIER_atomic_begin();
