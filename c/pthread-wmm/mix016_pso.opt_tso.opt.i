...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix016_pso.opt_tso.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t418;
  pthread_create(&t418, ((void *)0), P0, ((void *)0));
  pthread_t t419;
  pthread_create(&t419, ((void *)0), P1, ((void *)0));
  pthread_t t420;
  pthread_create(&t420, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
