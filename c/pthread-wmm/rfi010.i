...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "rfi010.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1761;
  pthread_create(&t1761, ((void *)0), P0, ((void *)0));
  pthread_t t1762;
  pthread_create(&t1762, ((void *)0), P1, ((void *)0));
  __VERIFIER_atomic_begin();
