...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe001_power.opt_pso.oepc_pso.opt_rmo.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1804;
  pthread_create(&t1804, ((void *)0), P0, ((void *)0));
  pthread_t t1805;
  pthread_create(&t1805, ((void *)0), P1, ((void *)0));
  pthread_t t1806;
  pthread_create(&t1806, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
