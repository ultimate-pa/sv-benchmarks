...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "thin002_rmo.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2721;
  pthread_create(&t2721, ((void *)0), P0, ((void *)0));
  pthread_t t2722;
  pthread_create(&t2722, ((void *)0), P1, ((void *)0));
  pthread_t t2723;
  pthread_create(&t2723, ((void *)0), P2, ((void *)0));
  pthread_t t2724;
  pthread_create(&t2724, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
