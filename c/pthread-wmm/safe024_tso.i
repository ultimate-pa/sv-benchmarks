...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe024_tso.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2363;
  pthread_create(&t2363, ((void *)0), P0, ((void *)0));
  pthread_t t2364;
  pthread_create(&t2364, ((void *)0), P1, ((void *)0));
  pthread_t t2365;
  pthread_create(&t2365, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
