...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix028_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t745;
  pthread_create(&t745, ((void *)0), P0, ((void *)0));
  pthread_t t746;
  pthread_create(&t746, ((void *)0), P1, ((void *)0));
  pthread_t t747;
  pthread_create(&t747, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
