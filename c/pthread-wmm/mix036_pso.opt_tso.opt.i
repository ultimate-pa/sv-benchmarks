...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix036_pso.opt_tso.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t949;
  pthread_create(&t949, ((void *)0), P0, ((void *)0));
  pthread_t t950;
  pthread_create(&t950, ((void *)0), P1, ((void *)0));
  pthread_t t951;
  pthread_create(&t951, ((void *)0), P2, ((void *)0));
  pthread_t t952;
  pthread_create(&t952, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
