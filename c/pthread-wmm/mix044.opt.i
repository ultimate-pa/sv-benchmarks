...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix044.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1165;
  pthread_create(&t1165, ((void *)0), P0, ((void *)0));
  pthread_t t1166;
  pthread_create(&t1166, ((void *)0), P1, ((void *)0));
  pthread_t t1167;
  pthread_create(&t1167, ((void *)0), P2, ((void *)0));
  pthread_t t1168;
  pthread_create(&t1168, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
