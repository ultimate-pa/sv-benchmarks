...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe023_tso.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2339;
  pthread_create(&t2339, ((void *)0), P0, ((void *)0));
  pthread_t t2340;
  pthread_create(&t2340, ((void *)0), P1, ((void *)0));
  pthread_t t2341;
  pthread_create(&t2341, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
