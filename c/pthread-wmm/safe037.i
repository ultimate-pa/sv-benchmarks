...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe037.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2641;
  pthread_create(&t2641, ((void *)0), P0, ((void *)0));
  pthread_t t2642;
  pthread_create(&t2642, ((void *)0), P1, ((void *)0));
  pthread_t t2643;
  pthread_create(&t2643, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
