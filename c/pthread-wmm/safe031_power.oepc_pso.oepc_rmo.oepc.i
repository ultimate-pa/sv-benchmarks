...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe031_power.oepc_pso.oepc_rmo.oepc.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2513;
  pthread_create(&t2513, ((void *)0), P0, ((void *)0));
  pthread_t t2514;
  pthread_create(&t2514, ((void *)0), P1, ((void *)0));
  pthread_t t2515;
  pthread_create(&t2515, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
