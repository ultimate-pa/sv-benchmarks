...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix021_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t553;
  pthread_create(&t553, ((void *)0), P0, ((void *)0));
  pthread_t t554;
  pthread_create(&t554, ((void *)0), P1, ((void *)0));
  pthread_t t555;
  pthread_create(&t555, ((void *)0), P2, ((void *)0));
  pthread_t t556;
  pthread_create(&t556, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
