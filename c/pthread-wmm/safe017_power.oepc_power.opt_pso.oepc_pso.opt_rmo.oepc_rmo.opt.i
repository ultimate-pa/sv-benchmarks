...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe017_power.oepc_power.opt_pso.oepc_pso.opt_rmo.oepc_rmo.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2177;
  pthread_create(&t2177, ((void *)0), P0, ((void *)0));
  pthread_t t2178;
  pthread_create(&t2178, ((void *)0), P1, ((void *)0));
  pthread_t t2179;
  pthread_create(&t2179, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
