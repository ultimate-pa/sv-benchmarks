...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix015.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t385;
  pthread_create(&t385, ((void *)0), P0, ((void *)0));
  pthread_t t386;
  pthread_create(&t386, ((void *)0), P1, ((void *)0));
  pthread_t t387;
  pthread_create(&t387, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
