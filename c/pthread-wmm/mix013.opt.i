...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix013.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t325;
  pthread_create(&t325, ((void *)0), P0, ((void *)0));
  pthread_t t326;
  pthread_create(&t326, ((void *)0), P1, ((void *)0));
  pthread_t t327;
  pthread_create(&t327, ((void *)0), P2, ((void *)0));
  pthread_t t328;
  pthread_create(&t328, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
