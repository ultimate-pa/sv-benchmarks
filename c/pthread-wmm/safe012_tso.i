...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe012_tso.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2067;
  pthread_create(&t2067, ((void *)0), P0, ((void *)0));
  pthread_t t2068;
  pthread_create(&t2068, ((void *)0), P1, ((void *)0));
  pthread_t t2069;
  pthread_create(&t2069, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
