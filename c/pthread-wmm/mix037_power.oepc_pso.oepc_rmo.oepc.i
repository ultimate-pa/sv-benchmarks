...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix037_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t969;
  pthread_create(&t969, ((void *)0), P0, ((void *)0));
  pthread_t t970;
  pthread_create(&t970, ((void *)0), P1, ((void *)0));
  pthread_t t971;
  pthread_create(&t971, ((void *)0), P2, ((void *)0));
  pthread_t t972;
  pthread_create(&t972, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
