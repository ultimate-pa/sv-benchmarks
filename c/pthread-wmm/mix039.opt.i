...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix039.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1029;
  pthread_create(&t1029, ((void *)0), P0, ((void *)0));
  pthread_t t1030;
  pthread_create(&t1030, ((void *)0), P1, ((void *)0));
  pthread_t t1031;
  pthread_create(&t1031, ((void *)0), P2, ((void *)0));
  pthread_t t1032;
  pthread_create(&t1032, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
