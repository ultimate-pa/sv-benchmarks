...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix007.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t181;
  pthread_create(&t181, ((void *)0), P0, ((void *)0));
  pthread_t t182;
  pthread_create(&t182, ((void *)0), P1, ((void *)0));
  pthread_t t183;
  pthread_create(&t183, ((void *)0), P2, ((void *)0));
  pthread_t t184;
  pthread_create(&t184, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
