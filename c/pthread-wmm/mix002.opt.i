...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix002.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t41;
  pthread_create(&t41, ((void *)0), P0, ((void *)0));
  pthread_t t42;
  pthread_create(&t42, ((void *)0), P1, ((void *)0));
  pthread_t t43;
  pthread_create(&t43, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
