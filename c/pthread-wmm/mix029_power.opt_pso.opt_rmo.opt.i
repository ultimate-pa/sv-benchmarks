...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix029_power.opt_pso.opt_rmo.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t773;
  pthread_create(&t773, ((void *)0), P0, ((void *)0));
  pthread_t t774;
  pthread_create(&t774, ((void *)0), P1, ((void *)0));
  pthread_t t775;
  pthread_create(&t775, ((void *)0), P2, ((void *)0));
  pthread_t t776;
  pthread_create(&t776, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
