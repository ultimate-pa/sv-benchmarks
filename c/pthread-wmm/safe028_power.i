...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe028_power.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2449;
  pthread_create(&t2449, ((void *)0), P0, ((void *)0));
  pthread_t t2450;
  pthread_create(&t2450, ((void *)0), P1, ((void *)0));
  pthread_t t2451;
  pthread_create(&t2451, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
