...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix032.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t849;
  pthread_create(&t849, ((void *)0), P0, ((void *)0));
  pthread_t t850;
  pthread_create(&t850, ((void *)0), P1, ((void *)0));
  pthread_t t851;
  pthread_create(&t851, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
