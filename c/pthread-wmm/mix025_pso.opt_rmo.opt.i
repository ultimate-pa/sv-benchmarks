...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix025_pso.opt_rmo.opt.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t666;
  pthread_create(&t666, ((void *)0), P0, ((void *)0));
  pthread_t t667;
  pthread_create(&t667, ((void *)0), P1, ((void *)0));
  pthread_t t668;
  pthread_create(&t668, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
