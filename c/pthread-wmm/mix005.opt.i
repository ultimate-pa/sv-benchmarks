...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix005.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t125;
  pthread_create(&t125, ((void *)0), P0, ((void *)0));
  pthread_t t126;
  pthread_create(&t126, ((void *)0), P1, ((void *)0));
  pthread_t t127;
  pthread_create(&t127, ((void *)0), P2, ((void *)0));
  pthread_t t128;
  pthread_create(&t128, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
