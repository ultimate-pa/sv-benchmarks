...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix008_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t209;
  pthread_create(&t209, ((void *)0), P0, ((void *)0));
  pthread_t t210;
  pthread_create(&t210, ((void *)0), P1, ((void *)0));
  pthread_t t211;
  pthread_create(&t211, ((void *)0), P2, ((void *)0));
  pthread_t t212;
  pthread_create(&t212, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
