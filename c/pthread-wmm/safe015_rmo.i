...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe015_rmo.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2133;
  pthread_create(&t2133, ((void *)0), P0, ((void *)0));
  pthread_t t2134;
  pthread_create(&t2134, ((void *)0), P1, ((void *)0));
  pthread_t t2135;
  pthread_create(&t2135, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
