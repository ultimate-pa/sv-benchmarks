...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe020_power.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2257;
  pthread_create(&t2257, ((void *)0), P0, ((void *)0));
  pthread_t t2258;
  pthread_create(&t2258, ((void *)0), P1, ((void *)0));
  pthread_t t2259;
  pthread_create(&t2259, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
