...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix030_tso.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t825;
  pthread_create(&t825, ((void *)0), P0, ((void *)0));
  pthread_t t826;
  pthread_create(&t826, ((void *)0), P1, ((void *)0));
  pthread_t t827;
  pthread_create(&t827, ((void *)0), P2, ((void *)0));
  pthread_t t828;
  pthread_create(&t828, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
