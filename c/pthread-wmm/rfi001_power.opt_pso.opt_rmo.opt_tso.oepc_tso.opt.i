...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "rfi001_power.opt_pso.opt_rmo.opt_tso.oepc_tso.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1603;
  pthread_create(&t1603, ((void *)0), P0, ((void *)0));
  pthread_t t1604;
  pthread_create(&t1604, ((void *)0), P1, ((void *)0));
  __VERIFIER_atomic_begin();
