...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix009.opt.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t243;
  pthread_create(&t243, ((void *)0), P0, ((void *)0));
  pthread_t t244;
  pthread_create(&t244, ((void *)0), P1, ((void *)0));
  __VERIFIER_atomic_begin();
