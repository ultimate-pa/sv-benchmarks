...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe000_rmo.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1789;
  pthread_create(&t1789, ((void *)0), P0, ((void *)0));
  pthread_t t1790;
  pthread_create(&t1790, ((void *)0), P1, ((void *)0));
  pthread_t t1791;
  pthread_create(&t1791, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
