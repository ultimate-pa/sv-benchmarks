...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe030_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2489;
  pthread_create(&t2489, ((void *)0), P0, ((void *)0));
  pthread_t t2490;
  pthread_create(&t2490, ((void *)0), P1, ((void *)0));
  pthread_t t2491;
  pthread_create(&t2491, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
