...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix004.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t93;
  pthread_create(&t93, ((void *)0), P0, ((void *)0));
  pthread_t t94;
  pthread_create(&t94, ((void *)0), P1, ((void *)0));
  pthread_t t95;
  pthread_create(&t95, ((void *)0), P2, ((void *)0));
  pthread_t t96;
  pthread_create(&t96, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
