...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix052_power.oepc_power.opt_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1385;
  pthread_create(&t1385, ((void *)0), P0, ((void *)0));
  pthread_t t1386;
  pthread_create(&t1386, ((void *)0), P1, ((void *)0));
  pthread_t t1387;
  pthread_create(&t1387, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
