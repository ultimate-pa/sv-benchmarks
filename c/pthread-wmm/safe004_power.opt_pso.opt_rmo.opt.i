...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe004_power.opt_pso.opt_rmo.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1876;
  pthread_create(&t1876, ((void *)0), P0, ((void *)0));
  pthread_t t1877;
  pthread_create(&t1877, ((void *)0), P1, ((void *)0));
  pthread_t t1878;
  pthread_create(&t1878, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
