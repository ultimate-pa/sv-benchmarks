...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix034_power.oepc_power.opt_pso.oepc_rmo.oepc_rmo.opt_tso.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t897;
  pthread_create(&t897, ((void *)0), P0, ((void *)0));
  pthread_t t898;
  pthread_create(&t898, ((void *)0), P1, ((void *)0));
  __VERIFIER_atomic_begin();
