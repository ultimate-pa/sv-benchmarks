...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix019_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t497;
  pthread_create(&t497, ((void *)0), P0, ((void *)0));
  pthread_t t498;
  pthread_create(&t498, ((void *)0), P1, ((void *)0));
  pthread_t t499;
  pthread_create(&t499, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
