...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe004_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1873;
  pthread_create(&t1873, ((void *)0), P0, ((void *)0));
  pthread_t t1874;
  pthread_create(&t1874, ((void *)0), P1, ((void *)0));
  pthread_t t1875;
  pthread_create(&t1875, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
