...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix020.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t521;
  pthread_create(&t521, ((void *)0), P0, ((void *)0));
  pthread_t t522;
  pthread_create(&t522, ((void *)0), P1, ((void *)0));
  pthread_t t523;
  pthread_create(&t523, ((void *)0), P2, ((void *)0));
  pthread_t t524;
  pthread_create(&t524, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
