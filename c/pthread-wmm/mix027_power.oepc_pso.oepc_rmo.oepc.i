...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix027_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t713;
  pthread_create(&t713, ((void *)0), P0, ((void *)0));
  pthread_t t714;
  pthread_create(&t714, ((void *)0), P1, ((void *)0));
  pthread_t t715;
  pthread_create(&t715, ((void *)0), P2, ((void *)0));
  pthread_t t716;
  pthread_create(&t716, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
