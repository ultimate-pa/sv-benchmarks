...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe002_tso.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1843;
  pthread_create(&t1843, ((void *)0), P0, ((void *)0));
  pthread_t t1844;
  pthread_create(&t1844, ((void *)0), P1, ((void *)0));
  pthread_t t1845;
  pthread_create(&t1845, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
