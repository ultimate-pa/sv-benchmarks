...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "rfi006_pso.oepc_pso.opt_tso.oepc_tso.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1687;
  pthread_create(&t1687, ((void *)0), P0, ((void *)0));
  pthread_t t1688;
  pthread_create(&t1688, ((void *)0), P1, ((void *)0));
  pthread_t t1689;
  pthread_create(&t1689, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
