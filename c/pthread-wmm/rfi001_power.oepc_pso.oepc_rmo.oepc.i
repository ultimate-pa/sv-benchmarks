...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "rfi001_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1601;
  pthread_create(&t1601, ((void *)0), P0, ((void *)0));
  pthread_t t1602;
  pthread_create(&t1602, ((void *)0), P1, ((void *)0));
  __VERIFIER_atomic_begin();
