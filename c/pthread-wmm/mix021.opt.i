...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix021.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t557;
  pthread_create(&t557, ((void *)0), P0, ((void *)0));
  pthread_t t558;
  pthread_create(&t558, ((void *)0), P1, ((void *)0));
  pthread_t t559;
  pthread_create(&t559, ((void *)0), P2, ((void *)0));
  pthread_t t560;
  pthread_create(&t560, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
