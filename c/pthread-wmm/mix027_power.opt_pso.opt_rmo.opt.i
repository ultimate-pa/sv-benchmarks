...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix027_power.opt_pso.opt_rmo.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t717;
  pthread_create(&t717, ((void *)0), P0, ((void *)0));
  pthread_t t718;
  pthread_create(&t718, ((void *)0), P1, ((void *)0));
  pthread_t t719;
  pthread_create(&t719, ((void *)0), P2, ((void *)0));
  pthread_t t720;
  pthread_create(&t720, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
