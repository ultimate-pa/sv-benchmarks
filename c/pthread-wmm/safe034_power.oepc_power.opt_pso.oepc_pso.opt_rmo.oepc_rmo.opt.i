...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe034_power.oepc_power.opt_pso.oepc_pso.opt_rmo.oepc_rmo.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2577;
  pthread_create(&t2577, ((void *)0), P0, ((void *)0));
  pthread_t t2578;
  pthread_create(&t2578, ((void *)0), P1, ((void *)0));
  pthread_t t2579;
  pthread_create(&t2579, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
