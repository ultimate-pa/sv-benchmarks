...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix027_tso.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t737;
  pthread_create(&t737, ((void *)0), P0, ((void *)0));
  pthread_t t738;
  pthread_create(&t738, ((void *)0), P1, ((void *)0));
  pthread_t t739;
  pthread_create(&t739, ((void *)0), P2, ((void *)0));
  pthread_t t740;
  pthread_create(&t740, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
