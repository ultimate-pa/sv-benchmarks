...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "rfi006_rmo.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1693;
  pthread_create(&t1693, ((void *)0), P0, ((void *)0));
  pthread_t t1694;
  pthread_create(&t1694, ((void *)0), P1, ((void *)0));
  pthread_t t1695;
  pthread_create(&t1695, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
