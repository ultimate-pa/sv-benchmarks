...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix046.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1217;
  pthread_create(&t1217, ((void *)0), P0, ((void *)0));
  pthread_t t1218;
  pthread_create(&t1218, ((void *)0), P1, ((void *)0));
  pthread_t t1219;
  pthread_create(&t1219, ((void *)0), P2, ((void *)0));
  pthread_t t1220;
  pthread_create(&t1220, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
