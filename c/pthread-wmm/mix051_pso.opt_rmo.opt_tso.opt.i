...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix051_pso.opt_rmo.opt_tso.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t1365;
  pthread_create(&t1365, ((void *)0), P0, ((void *)0));
  pthread_t t1366;
  pthread_create(&t1366, ((void *)0), P1, ((void *)0));
  pthread_t t1367;
  pthread_create(&t1367, ((void *)0), P2, ((void *)0));
  pthread_t t1368;
  pthread_create(&t1368, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
