...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix030_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t801;
  pthread_create(&t801, ((void *)0), P0, ((void *)0));
  pthread_t t802;
  pthread_create(&t802, ((void *)0), P1, ((void *)0));
  pthread_t t803;
  pthread_create(&t803, ((void *)0), P2, ((void *)0));
  pthread_t t804;
  pthread_create(&t804, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
