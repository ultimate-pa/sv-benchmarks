...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix020.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t525;
  pthread_create(&t525, ((void *)0), P0, ((void *)0));
  pthread_t t526;
  pthread_create(&t526, ((void *)0), P1, ((void *)0));
  pthread_t t527;
  pthread_create(&t527, ((void *)0), P2, ((void *)0));
  pthread_t t528;
  pthread_create(&t528, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
