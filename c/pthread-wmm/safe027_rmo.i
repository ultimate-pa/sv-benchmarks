...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "safe027_rmo.c", 9, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t2433;
  pthread_create(&t2433, ((void *)0), P0, ((void *)0));
  pthread_t t2434;
  pthread_create(&t2434, ((void *)0), P1, ((void *)0));
  pthread_t t2435;
  pthread_create(&t2435, ((void *)0), P2, ((void *)0));
  pthread_t t2436;
  pthread_create(&t2436, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
