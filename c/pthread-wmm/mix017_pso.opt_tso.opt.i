...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix017_pso.opt_tso.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t445;
  pthread_create(&t445, ((void *)0), P0, ((void *)0));
  pthread_t t446;
  pthread_create(&t446, ((void *)0), P1, ((void *)0));
  pthread_t t447;
  pthread_create(&t447, ((void *)0), P2, ((void *)0));
  pthread_t t448;
  pthread_create(&t448, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
