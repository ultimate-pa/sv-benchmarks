...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix055_power.oepc_pso.oepc_rmo.oepc.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
int main()
{
  ...
  pthread_t t1459;
  pthread_create(&t1459, ((void *)0), P2, ((void *)0));
  pthread_t t1460;
  pthread_create(&t1460, ((void *)0), P3, ((void *)0));
  __VERIFIER_atomic_begin();
