...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "mix033.opt.c", 8, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  pthread_t t876;
  pthread_create(&t876, ((void *)0), P0, ((void *)0));
  pthread_t t877;
  pthread_create(&t877, ((void *)0), P1, ((void *)0));
  pthread_t t878;
  pthread_create(&t878, ((void *)0), P2, ((void *)0));
  __VERIFIER_atomic_begin();
