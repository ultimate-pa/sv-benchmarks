...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "13-privatized_29-multiple-protecting2-vesal_true.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
int g2;
pthread_mutex_t mutex1 = { { 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, { { 0, 0 } } } };
pthread_mutex_t mutex2 = { { 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, { { 0, 0 } } } };
...
int main(void) {
  pthread_t id2;
  pthread_create(&id2, ((void *)0), t2_fun, ((void *)0));
