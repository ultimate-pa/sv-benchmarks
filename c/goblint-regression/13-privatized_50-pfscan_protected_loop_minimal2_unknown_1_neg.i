...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "13-privatized_50-pfscan_protected_loop_minimal2_unknown_1_neg.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
pthread_mutex_t print_lock = { { 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, { { 0, 0 } } } };
