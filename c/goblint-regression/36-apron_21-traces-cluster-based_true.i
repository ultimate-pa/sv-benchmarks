...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "36-apron_21-traces-cluster-based_true.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
pthread_mutex_t B = { { 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, { { 0, 0 } } } };
void *t_fun(void *arg) {
...
int main(void) {
  ...
  pthread_create(&id3, ((void *)0), t3_fun, ((void *)0));
  pthread_mutex_lock(&A);
  x = g;
  y = h;
  pthread_mutex_lock(&B);
