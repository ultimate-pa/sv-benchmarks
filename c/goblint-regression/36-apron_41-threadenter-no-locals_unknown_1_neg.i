...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "36-apron_41-threadenter-no-locals_unknown_1_neg.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
