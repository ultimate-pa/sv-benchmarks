...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "13-privatized_46-refine-protected1_true.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
