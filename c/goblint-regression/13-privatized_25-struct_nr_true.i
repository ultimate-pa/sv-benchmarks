...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "13-privatized_25-struct_nr_true.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
int glob1 = 5;
struct lock lock1 = {.mutex = { { 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, { { 0, 0 } } } }};
void *t_fun(void *arg) {
  int t;
