...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "13-privatized_67-pthread_cond_wait_unknown_1_neg.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
int g;
pthread_mutex_t mut = { { 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, { { 0, 0 } } } };
...
int main(int argc, char const *argv[])
{
    ...
    sleep(1);
    pthread_create(&t2,((void *)0),f2,((void *)0));
