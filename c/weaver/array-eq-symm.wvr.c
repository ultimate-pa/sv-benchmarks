...
//
// SPDX-License-Identifier: License-BSD-3-Clause-Attribution-Vandikas
...
void reach_error() { __assert_fail("0", "array-eq-symm.wvr.c", 21, __extension__ __PRETTY_FUNCTION__); }
