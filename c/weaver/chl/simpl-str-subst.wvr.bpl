...
* The original file name was 'weaver/examples/chl/simpl-str-subst.wvr'.
*
...
modifies length_0, to_int_1, length_2, to_int_3, length_4, to_int_5, result_6, result_7, result_8;
{
  result_7 := ( if ( length_0 == 0 ) then ( if ( length_4 == 0 ) then 0 else 1 ) else ( if ( length_4 == 0 ) then ( 0 - 1 ) else ( to_int_1 - to_int_5 ) ) );
}

procedure thread3() returns ()
modifies length_0, to_int_1, length_2, to_int_3, length_4, to_int_5, result_6, result_7, result_8;
{
  result_8 := ( if ( length_2 == 0 ) then ( if ( length_4 == 0 ) then 0 else 1 ) else ( if ( length_4 == 0 ) then ( 0 - 1 ) else ( to_int_3 - to_int_5 ) ) );
}
