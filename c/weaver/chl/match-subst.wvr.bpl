...
* The original file name was 'weaver/examples/chl/match-subst.wvr'.
*
...
modifies score_0, seq_1_start_1, seq_2_start_2, score_3, seq_1_start_4, seq_2_start_5, score_6, seq_1_start_7, seq_2_start_8, result_9, result_10, result_11;
{
  result_10 := ( if ( score_0 > score_6 ) then ( 0 - 1 ) else ( if ( score_0 < score_6 ) then 1 else ( if ( ( seq_1_start_1 + seq_2_start_2 ) < ( seq_1_start_7 + seq_2_start_8 ) ) then ( 0 - 1 ) else ( if ( ( seq_1_start_1 + seq_2_start_2 ) > ( seq_1_start_7 + seq_2_start_8 ) ) then 1 else 0 ) ) ) );
}

procedure thread3() returns ()
modifies score_0, seq_1_start_1, seq_2_start_2, score_3, seq_1_start_4, seq_2_start_5, score_6, seq_1_start_7, seq_2_start_8, result_9, result_10, result_11;
{
  result_11 := ( if ( score_3 > score_6 ) then ( 0 - 1 ) else ( if ( score_3 < score_6 ) then 1 else ( if ( ( seq_1_start_4 + seq_2_start_5 ) < ( seq_1_start_7 + seq_2_start_8 ) ) then ( 0 - 1 ) else ( if ( ( seq_1_start_4 + seq_2_start_5 ) > ( seq_1_start_7 + seq_2_start_8 ) ) then 1 else 0 ) ) ) );
}
