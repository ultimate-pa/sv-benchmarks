...
* The original file name was 'weaver/examples/chl/poker-hand-trans.wvr'.
*
  ...
  if (*) {
    ...
    while (*) {
      atomic {
        ...
        result_17 := ( if ( ( char_at_5[i1_18] != 0 ) && ( ( char_at_5[i1_18] != 4 ) && ( ( char_at_9[i1_18] != 0 ) && ( char_at_9[i1_18] != 4 ) ) ) ) then 0 else ( if ( ( char_at_5[i1_18] != 0 ) && ( char_at_5[i1_18] != 4 ) ) then ( 0 - 1 ) else ( if ( ( char_at_9[i1_18] != 0 ) && ( char_at_9[i1_18] != 4 ) ) then 1 else result_17 ) ) );
        break_19 := ( if ( ( ( char_at_5[i1_18] != 0 ) && ( char_at_5[i1_18] != 4 ) ) || ( ( char_at_9[i1_18] != 0 ) && ( char_at_9[i1_18] != 4 ) ) ) then true else break_19 );
        i1_18 := ( i1_18 + 1 );
      }
    }
    atomic {
      assume !( !break_19 && ( i1_18 <= 12 ) );
      result_17 := ( if !break_19 then ( index_of_4[4] - index_of_8[4] ) else result_17 );
    }
  }
  else if (*) {
    atomic {
    ...
    while (*) {
      atomic {
        ...
        result_17 := ( if ( ( i2_20 != last_index_of_7[3] ) && ( ( ( char_at_5[i2_20] == 2 ) || ( char_at_5[i2_20] == 3 ) ) && ( ( char_at_9[i2_20] == 2 ) || ( char_at_9[i2_20] == 3 ) ) ) ) then 0 else ( if ( ( i2_20 != last_index_of_7[3] ) && ( ( char_at_5[i2_20] == 2 ) || ( char_at_5[i2_20] == 3 ) ) ) then ( 0 - 1 ) else ( if ( ( i2_20 != last_index_of_7[3] ) && ( ( char_at_9[i2_20] == 2 ) || ( char_at_9[i2_20] == 3 ) ) ) then 1 else result_17 ) ) );
        break_21 := ( if ( ( i2_20 != last_index_of_7[3] ) && ( ( char_at_5[i2_20] == 2 ) || ( ( char_at_5[i2_20] == 3 ) || ( ( char_at_9[i2_20] == 2 ) || ( char_at_9[i2_20] == 3 ) ) ) ) ) then true else break_21 );
      }
    }
    atomic {
      assume !( !break_21 && ( i2_20 <= 12 ) );
      result_17 := ( if !break_21 then ( last_index_of_7[3] - last_index_of_11[3] ) else result_17 );
    }
  }
  else if (*) {
    atomic {
  ...
  if (*) {
    ...
    while (*) {
      atomic {
        ...
        result_22 := ( if ( ( char_at_1[i1_23] != 0 ) && ( ( char_at_1[i1_23] != 4 ) && ( ( char_at_9[i1_23] != 0 ) && ( char_at_9[i1_23] != 4 ) ) ) ) then 0 else ( if ( ( char_at_1[i1_23] != 0 ) && ( char_at_1[i1_23] != 4 ) ) then ( 0 - 1 ) else ( if ( ( char_at_9[i1_23] != 0 ) && ( char_at_9[i1_23] != 4 ) ) then 1 else result_22 ) ) );
        break_24 := ( if ( ( ( char_at_1[i1_23] != 0 ) && ( char_at_1[i1_23] != 4 ) ) || ( ( char_at_9[i1_23] != 0 ) && ( char_at_9[i1_23] != 4 ) ) ) then true else break_24 );
        i1_23 := ( i1_23 + 1 );
      }
    }
    atomic {
      assume !( !break_24 && ( i1_23 <= 12 ) );
      result_22 := ( if !break_24 then ( index_of_0[4] - index_of_8[4] ) else result_22 );
    }
  }
  else if (*) {
    atomic {
    ...
    while (*) {
      atomic {
        ...
        result_22 := ( if ( ( i2_25 != last_index_of_3[3] ) && ( ( ( char_at_1[i2_25] == 2 ) || ( char_at_1[i2_25] == 3 ) ) && ( ( char_at_9[i2_25] == 2 ) || ( char_at_9[i2_25] == 3 ) ) ) ) then 0 else ( if ( ( i2_25 != last_index_of_3[3] ) && ( ( char_at_1[i2_25] == 2 ) || ( char_at_1[i2_25] == 3 ) ) ) then ( 0 - 1 ) else ( if ( ( i2_25 != last_index_of_3[3] ) && ( ( char_at_9[i2_25] == 2 ) || ( char_at_9[i2_25] == 3 ) ) ) then 1 else result_22 ) ) );
        break_26 := ( if ( ( i2_25 != last_index_of_3[3] ) && ( ( char_at_1[i2_25] == 2 ) || ( ( char_at_1[i2_25] == 3 ) || ( ( char_at_9[i2_25] == 2 ) || ( char_at_9[i2_25] == 3 ) ) ) ) ) then true else break_26 );
      }
    }
    atomic {
      assume !( !break_26 && ( i2_25 <= 12 ) );
      result_22 := ( if !break_26 then ( last_index_of_3[3] - last_index_of_11[3] ) else result_22 );
    }
  }
  else if (*) {
    atomic {
...
modifies index_of_0, char_at_1, count_occurrences_of_2, last_index_of_3, index_of_4, char_at_5, count_occurrences_of_6, last_index_of_7, index_of_8, char_at_9, count_occurrences_of_10, last_index_of_11, result_12, i1_13, break_14, i2_15, break_16, result_17, i1_18, break_19, i2_20, break_21, result_22, i1_23, break_24, i2_25, break_26;
{
  ...
  join 2,2;
  join 3,3,3;
  assume !( ( ( result_12 > 0 ) && ( result_17 > 0 ) ) ==> ( result_22 > 0 ) );
