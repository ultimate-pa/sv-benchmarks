...
* The original file name was 'weaver/examples/chl/time-subst.wvr'.
*
...
modifies ora_0, volume_totale_1, ora_2, volume_totale_3, ora_4, volume_totale_5, cmp_6, cmp_7, cmp_8;
{
  atomic {
    cmp_7 := ( ora_0 - ora_4 );
    cmp_7 := ( if ( cmp_7 == 0 ) then ( volume_totale_1 - volume_totale_5 ) else cmp_7 );
  }
}
...
modifies ora_0, volume_totale_1, ora_2, volume_totale_3, ora_4, volume_totale_5, cmp_6, cmp_7, cmp_8;
{
  atomic {
    cmp_8 := ( ora_2 - ora_4 );
    cmp_8 := ( if ( cmp_8 == 0 ) then ( volume_totale_3 - volume_totale_5 ) else cmp_8 );
  }
}
...
modifies ora_0, volume_totale_1, ora_2, volume_totale_3, ora_4, volume_totale_5, cmp_6, cmp_7, cmp_8;
{
  ...
  join 2,2;
  join 3,3,3;
  assume !( ( cmp_6 == 0 ) ==> ( ( ( cmp_7 > 0 ) == ( cmp_8 > 0 ) ) && ( ( cmp_7 < 0 ) == ( cmp_8 < 0 ) ) ) );
