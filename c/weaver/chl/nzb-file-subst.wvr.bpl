...
* The original file name was 'weaver/examples/chl/nzb-file-subst.wvr'.
*
  ...
  if (*) {
    ...
    while (*) {
      atomic {
        ...
        result_15 := ( if ( ends_with_2[i_16] && ends_with_10[i_16] ) then 0 else result_15 );
        break_17 := ( if ( ends_with_2[i_16] && ends_with_10[i_16] ) then true else break_17 );
        result_15 := ( if ( !break_17 && ends_with_2[i_16] ) then ( ( 0 - 1000 ) + i_16 ) else result_15 );
        break_17 := ( if ( !break_17 && ends_with_2[i_16] ) then true else break_17 );
    ...
    atomic {
      assume !( ( i_16 < 5 ) && !break_17 );
      result_15 := ( if !break_17 then ( filename_0 - filename_8 ) else result_15 );
    }
  }
  else {
    atomic {
      assume !( !is_null_1 && !is_null_9 );
      result_15 := ( if ( !is_null_1 && is_null_9 ) then ( 0 - 995 ) else ( if ( is_null_1 && !is_null_9 ) then 1005 else ( get_subject_3 - get_subject_11 ) ) );
    }
  }
}
  ...
  if (*) {
    ...
    while (*) {
      atomic {
        ...
        result_18 := ( if ( ends_with_6[i_19] && ends_with_10[i_19] ) then 0 else result_18 );
        break_20 := ( if ( ends_with_6[i_19] && ends_with_10[i_19] ) then true else break_20 );
        result_18 := ( if ( !break_20 && ends_with_6[i_19] ) then ( ( 0 - 1000 ) + i_19 ) else result_18 );
        break_20 := ( if ( !break_20 && ends_with_6[i_19] ) then true else break_20 );
    ...
    atomic {
      assume !( ( i_19 < 5 ) && !break_20 );
      result_18 := ( if !break_20 then ( filename_4 - filename_8 ) else result_18 );
    }
  }
  else {
    atomic {
      assume !( !is_null_5 && !is_null_9 );
      result_18 := ( if ( !is_null_5 && is_null_9 ) then ( 0 - 995 ) else ( if ( is_null_5 && !is_null_9 ) then 1005 else ( get_subject_7 - get_subject_11 ) ) );
    }
  }
}
...
modifies filename_0, is_null_1, ends_with_2, get_subject_3, filename_4, is_null_5, ends_with_6, get_subject_7, filename_8, is_null_9, ends_with_10, get_subject_11, result_12, i_13, break_14, result_15, i_16, break_17, result_18, i_19, break_20;
{
  ...
  join 2,2;
  join 3,3,3;
  assume !( ( result_12 == 0 ) ==> ( ( ( result_15 > 0 ) == ( result_18 > 0 ) ) && ( ( result_15 < 0 ) == ( result_18 < 0 ) ) ) );
