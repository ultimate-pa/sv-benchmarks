...
* The original file name was 'weaver/examples/chl/node-trans.wvr'.
*
...
modifies id_0, contains_key_1, get_2, id_3, contains_key_4, get_5, id_6, contains_key_7, get_8, result_9, order1_10, order2_11, result_12, order1_13, order2_14, result_15, order1_16, order2_17;
{
  atomic {
    ...
    result_12 := ( if ( contains_key_4[id_3] && contains_key_7[id_6] ) then ( if ( order1_13 < order2_14 ) then ( 0 - 1 ) else ( if ( order1_13 > order2_14 ) then 1 else 0 ) ) else ( get_5[id_3] - get_8[id_6] ) );
  }
}
...
modifies id_0, contains_key_1, get_2, id_3, contains_key_4, get_5, id_6, contains_key_7, get_8, result_9, order1_10, order2_11, result_12, order1_13, order2_14, result_15, order1_16, order2_17;
{
  atomic {
    ...
    result_15 := ( if ( contains_key_1[id_0] && contains_key_7[id_6] ) then ( if ( order1_16 < order2_17 ) then ( 0 - 1 ) else ( if ( order1_16 > order2_17 ) then 1 else 0 ) ) else ( get_2[id_0] - get_8[id_6] ) );
  }
}
...
modifies id_0, contains_key_1, get_2, id_3, contains_key_4, get_5, id_6, contains_key_7, get_8, result_9, order1_10, order2_11, result_12, order1_13, order2_14, result_15, order1_16, order2_17;
{
  ...
  join 2,2;
  join 3,3,3;
  assume !( ( ( result_9 > 0 ) && ( result_12 > 0 ) ) ==> ( result_15 > 0 ) );
