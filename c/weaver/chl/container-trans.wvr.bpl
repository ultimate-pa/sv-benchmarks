...
* The original file name was 'weaver/examples/chl/container-trans.wvr'.
*
...
{
  atomic {
    result_13 := ( departure_time_4 - departure_time_8 );
    result_13 := ( if ( result_13 == 0 ) then ( departure_max_duration_5 - departure_max_duration_9 ) else result_13 );
    result_13 := ( if ( result_13 == 0 ) then ( departure_transport_company_6 - departure_transport_company_10 ) else result_13 );
    result_13 := ( if ( result_13 == 0 ) then ( departure_transport_type_7 - departure_transport_type_11 ) else result_13 );
  }
}
...
{
  atomic {
    result_14 := ( departure_time_0 - departure_time_8 );
    result_14 := ( if ( result_14 == 0 ) then ( departure_max_duration_1 - departure_max_duration_9 ) else result_14 );
    result_14 := ( if ( result_14 == 0 ) then ( departure_transport_company_2 - departure_transport_company_10 ) else result_14 );
    result_14 := ( if ( result_14 == 0 ) then ( departure_transport_type_3 - departure_transport_type_11 ) else result_14 );
  }
}
