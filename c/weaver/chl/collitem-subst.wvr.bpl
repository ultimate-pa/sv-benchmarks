...
* The original file name was 'weaver/examples/chl/collitem-subst.wvr'.
*
...
{
  atomic {
    result_13 := ( cardSet_0 - cardSet_8 );
    result_13 := ( if ( result_13 == 0 ) then ( cardRarity_1 - cardRarity_9 ) else result_13 );
    result_13 := ( if ( result_13 == 0 ) then ( cardId_2 - cardId_10 ) else result_13 );
    result_13 := ( if ( result_13 == 0 ) then ( cardType_3 - cardType_11 ) else result_13 );
  }
}
...
{
  atomic {
    result_14 := ( cardSet_4 - cardSet_8 );
    result_14 := ( if ( result_14 == 0 ) then ( cardRarity_5 - cardRarity_9 ) else result_14 );
    result_14 := ( if ( result_14 == 0 ) then ( cardId_6 - cardId_10 ) else result_14 );
    result_14 := ( if ( result_14 == 0 ) then ( cardType_7 - cardType_11 ) else result_14 );
  }
}
