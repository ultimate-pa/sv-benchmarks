...
* The original file name was 'weaver/examples/chl/name-comparator-subst.wvr'.
*
...
modifies nondet_0, name_1, name_2, name_3, result_4, i_5, current_6, break_7, result_8, i_9, current_10, break_11, result_12, i_13, current_14, break_15;
{
  atomic {
    i_9 := 0;
    break_11 := false;
    result_8 := ( if ( name_1 == name_3 ) then 0 else result_8 );
    break_11 := ( if ( name_1 == name_3 ) then true else break_11 );
  }
  while (*) {
    atomic {
      assume ( ( i_9 < 3 ) && !break_11 );
      current_10 := nondet_0[i_9];
      result_8 := ( if ( current_10 == name_1 ) then 1 else result_8 );
      break_11 := ( if ( current_10 == name_1 ) then true else break_11 );
  ...
  atomic {
    assume !( ( i_9 < 3 ) && !break_11 );
    result_8 := ( if !break_11 then ( name_1 - name_3 ) else result_8 );
  }
}
...
modifies nondet_0, name_1, name_2, name_3, result_4, i_5, current_6, break_7, result_8, i_9, current_10, break_11, result_12, i_13, current_14, break_15;
{
  atomic {
    i_13 := 0;
    break_15 := false;
    result_12 := ( if ( name_2 == name_3 ) then 0 else result_12 );
    break_15 := ( if ( name_2 == name_3 ) then true else break_15 );
  }
  while (*) {
    atomic {
      assume ( ( i_13 < 3 ) && !break_15 );
      current_14 := nondet_0[i_13];
      result_12 := ( if ( current_14 == name_2 ) then 1 else result_12 );
      break_15 := ( if ( current_14 == name_2 ) then true else break_15 );
  ...
  atomic {
    assume !( ( i_13 < 3 ) && !break_15 );
    result_12 := ( if !break_15 then ( name_2 - name_3 ) else result_12 );
  }
}
...
modifies nondet_0, name_1, name_2, name_3, result_4, i_5, current_6, break_7, result_8, i_9, current_10, break_11, result_12, i_13, current_14, break_15;
{
  ...
  join 2,2;
  join 3,3,3;
  assume !( ( result_4 == 0 ) ==> ( ( ( result_8 > 0 ) == ( result_12 > 0 ) ) && ( ( result_8 < 0 ) == ( result_12 < 0 ) ) ) );
