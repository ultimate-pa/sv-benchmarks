...
* The original file name was 'weaver/examples/popl20/commit-2.wvr'.
*
...
modifies manager, manager_front, manager_back, client, client_front, client_back, node_1, node_1_front, node_1_back, node_2, node_2_front, node_2_back, update, ok, safe;
{
  while (*) {
    atomic {
...
modifies manager, manager_front, manager_back, client, client_front, client_back, node_1, node_1_front, node_1_back, node_2, node_2_front, node_2_back, update, ok, safe;
{
  while (*) {
    atomic {
      ...
      safe := ( safe && ( node_2[node_2_front] == update ) );
...
modifies manager, manager_front, manager_back, client, client_front, client_back, node_1, node_1_front, node_1_back, node_2, node_2_front, node_2_back, update, ok, safe;
{
  assume ( ( safe == true ) && ( manager_front == manager_back ) && ( client_front == client_back ) && ( node_1_front == node_1_back ) && ( node_2_front == node_2_back ) );
  fork 1 thread1();
  fork 2,2 thread2();
  fork 3,3,3 thread3();
