...
void reach_error() { __assert_fail("0", "parallel-min-max-2.wvr.c", 21, __extension__ __PRETTY_FUNCTION__); }
...
int main() {
  ...
  // main method
  assume_abort_if_not( ( i == j && i == k && i == l && i == 0 ) && ( v_assert == b1 && v_assert == b2 && v_assert == 0 ) );
