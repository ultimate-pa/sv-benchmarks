...
void reach_error() { __assert_fail("0", "chl-chromosome-subst.wvr.c", 21, __extension__ __PRETTY_FUNCTION__); }
...
int main() {
  ...
  assume_abort_if_not(result_7 == 0);
  assume_abort_if_not((result_10 > 0) != (result_13 > 0) || (result_10 < 0) != (result_13 < 0));
  reach_error();
