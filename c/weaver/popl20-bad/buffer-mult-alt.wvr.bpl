...
* The original file name was 'weaver/examples/popl20-bad/buffer-mult-alt.wvr'.
*
...
modifies i, j, total, C, N, M, q1, q2, q1_front, q1_back, q2_front, q2_back;
{
  while (( i < N )) {
    atomic {
      assume ( q1[q1_back] == C );
...
modifies i, j, total, C, N, M, q1, q2, q1_front, q1_back, q2_front, q2_back;
{
  assume ( ( N > M ) && ( M >= 0 ) && ( C > 0 ) && ( q1_front == q1_back ) && ( q2_front == q2_back ) && ( total == 0 ) && ( i == 0 ) && ( j == 0 ) );
  fork 1 thread1();
  fork 2,2 thread2();
  fork 3,3,3 thread3();
