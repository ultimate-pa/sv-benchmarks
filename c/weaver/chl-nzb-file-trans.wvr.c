...
void reach_error() { __assert_fail("0", "nzb-file-trans.wvr.c", 21, __extension__ __PRETTY_FUNCTION__); }
...
void* thread2() {
  if ( __VERIFIER_nondet_bool() ) {
    ...
    __VERIFIER_atomic_begin();
    assume_abort_if_not( !( ( i_16 < 5 ) && !break_17 ) );
    result_15 = ( (!break_17) ? ( filename_4 - filename_8 ) : result_15 );
    __VERIFIER_atomic_end();
  }
  else {
    __VERIFIER_atomic_begin();
...
void* thread3() {
  if ( __VERIFIER_nondet_bool() ) {
    ...
    __VERIFIER_atomic_begin();
    assume_abort_if_not( !( ( i_19 < 5 ) && !break_20 ) );
    result_18 = ( (!break_20) ? ( filename_0 - filename_8 ) : result_18 );
    __VERIFIER_atomic_end();
  }
  else {
    __VERIFIER_atomic_begin();
