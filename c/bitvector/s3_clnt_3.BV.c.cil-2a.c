...
void reach_error() { __assert_fail("0", "s3_clnt_3.BV.c.cil-2a.c", 3, "reach_error"); }
...
{ int s__info_callback  = __VERIFIER_nondet_int();
  ...
  unsigned int s__ctx__stats__sess_connect = __VERIFIER_nondet_uint();
                                                                  ...
                                                                  if (s__state == 4352) {
                                                                    ...
                                                                    if (s__state == 3) {
                                                                      ...
                                                                      if (0) {
                                                                        ...
                                                                        s__state = 4352;
                                                                        s__s3__flags = (unsigned long )s__s3__flags + -5L;
                                                                        if (s__hit) {
                                                                          s__s3__tmp__next_state___0 = 3;
                                                                          if ((unsigned long )s__s3__flags + 2L) {
                                                                            s__state = 3;
                                                                            s__s3__flags = (unsigned long )s__s3__flags * 4L;
                                                                        ...
                                                                        if (! ((unsigned long )s__s3__flags + 4L)) {
